...
export const onRequestPost: PagesFunction<Env> = async (ctx) => {
  try {
    ...
    // EVERY key ever shipped stays accepted. 'standard@7' is what the current
    ...
    // ever grows.
    const AI_KEYS = new Set(['standard', 'standard@2', 'standard@3', 'standard@4', 'standard@5', 'standard@6', 'standard@7']);
